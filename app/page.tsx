...
export default function Home() {
  ...
  useEffect(() => {
    ...
    // Load guest favorites into savedKeys
    ...
    <div className="min-h-screen bg-background">
      <div className="border-b border-light-border">
        <div className="max-w-6xl mx-auto px-6 py-16 text-center">
          ...
          <p className="text-warm-gray max-w-lg mx-auto text-lg">A curated collection of our favorite reads.</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        {loading ? (
          ...
          <>
            <p className="text-sm text-warm-gray mb-8 font-[family-name:var(--font-special-elite)] tracking-wider">
              {books.length} {books.length === 1 ? "book" : "books"} on the shelf
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-8">
              {books.map((book) => (
                <div key={book.ol_key} onClick={() => { setSelected(book); setShowDetails(false); setDetails(null); }} className="group cursor-pointer relative">
                  ...
                  <p className="text-[10px] text-muted-gold mt-1 flex items-center gap-1">
